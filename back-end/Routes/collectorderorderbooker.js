...
var shopownerrmodel = require("../Model/shopowner");
var bookermodel = require("../Model/orderbooker");
var shopownerrmodel = require("../Model/shopowner");

var mybooker = bookermodel.find({});
  ...
  router.post(
    ...
    (req, res) => {
      ...
      var bookerdetail = new bookermodel({
        uploderid: ObjectId(obj.uploderid),
      ...
      bookerdetail.save(function (err, res1) {
        ...
        mybooker.exec(async function (err, data) {
          if (err) throw err;
