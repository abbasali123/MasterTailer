...
// core components
import DarziOrders from "./darziOrders/DarziOrders";
...
export default function RegNavBar() {
  ...
  const [selectedFile2Err, setselectedFile2Err] = useState("");
  const [selectedFile3Err, setselectedFile3Err] = useState("");
  const [selectedFile4Err, setselectedFile4Err] = useState("");
  const [shopnameErr, setshopnameErr] = useState("");
  const [shoplandlineErr, setshoplandlineErr] = useState("");
  const [shopnoErr, setshopnoErr] = useState("");

  const [deptnoErr, setdeptnoErr] = useState("");
  const [markdeptnoErr, setmarkdeptnoErr] = useState("");

  const [offemailErr, setoffemailErr] = useState("");
  const [offwnumberErr, setoffwnumberErr] = useState("");
  const [shopregaddressErr, setshopregaddressErr] = useState("");

  const [ntnnoErr, setntnnoErr] = useState("");
  ...
  const [shoplandline, setshoplandline] = useState("");
  const [shopno, setshopno] = useState("");

  const [deptno, setdeptno] = useState("");
  const [markdeptno, setmarkdeptno] = useState("");

  const [offemail, setoffemail] = useState("");
  const [offwnumber, setoffwnumber] = useState("");
  const [shopregaddress, setshopregaddress] = useState("");
  ...
  const validfile3 = () => {
    console.log("inValidate");
    let selectedFile2Err = "";
    if (!selectedFile2 != "") {
      selectedFile2Err = "invalid selectedFile1Err";
      console.log("inValidat");
    }

    if (selectedFile2Err) {
      setselectedFile2Err({ selectedFile2Err });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validfile4 = () => {
    console.log("inValidate");
    let selectedFile3Err = "";
    if (!selectedFile3 != "") {
      selectedFile3Err = "invalid selectedFile1Err";
      console.log("inValidat");
    }

    if (selectedFile3Err) {
      setselectedFile3Err({ selectedFile3Err });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validfile5 = () => {
    console.log("inValidate");
    let selectedFile4Err = "";
    if (!selectedFile4 != "") {
      selectedFile4Err = "invalid selectedFile1Err";
      console.log("inValidat");
    }

    if (selectedFile4Err) {
      setselectedFile4Err({ selectedFile4Err });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validsname = () => {
    ...
    let shopnameErr = "";
    if (!shopname != "") {
      shopnameErr = "invalid shopnameErr";
      console.log("inValidat");
    }

    if (shopnameErr) {
      setshopnameErr({ shopnameErr });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validlandline = () => {
    ...
    let shoplandlineErr = "";
    if (!shoplandline != "") {
      shoplandlineErr = "invalid fname";
      console.log("inValidat");
    }

    if (shoplandlineErr) {
      setshoplandlineErr({ shoplandlineErr });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validshopno = () => {
    ...
    let shopnoErr = "";
    if (!shopno != "") {
      shopnoErr = "invalid shopnoErr";
      console.log("inValidat");
    }

    if (shopnoErr) {
      setshopnoErr({ shopnoErr });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validdeptno = () => {
    ...
    let deptnoErr = "";
    if (!deptno != "") {
      deptnoErr = "invalid deptnoErr";
      console.log("inValidat");
    }

    if (deptnoErr) {
      setdeptnoErr({ deptnoErr });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validmarkdeptno = () => {
    console.log("inValidate");
    let markdeptnoErr = "";
    if (!markdeptno != "") {
      markdeptnoErr = "invalid markdeptnoErr";
      console.log("inValidat");
    }

    if (markdeptnoErr) {
      setmarkdeptnoErr({ markdeptnoErr });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validoffemail = () => {
    console.log("inValidate");
    let offemailErr = "";
    if (!offemail.includes("@")) {
      offemailErr = "invalid offemailErr";
      console.log("inValidat");
    }

    if (offemailErr) {
      setoffemailErr({ offemailErr });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validoffwnumber = () => {
    console.log("inValidate");
    let offwnumberErr = "";
    if (!offwnumber != "") {
      offwnumberErr = "invalid offwnumberErr";
      console.log("inValidat");
    }

    if (offwnumberErr) {
      setoffwnumberErr({ offwnumberErr });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validshopregaddress = () => {
    console.log("inValidate");
    let shopregaddressErr = "";
    if (!shopregaddress != "") {
      shopregaddressErr = "invalid shopregaddressErr";
      console.log("inValidat");
    }

    if (shopregaddressErr) {
      setshopregaddressErr({ shopregaddressErr });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const validntnno = () => {
    ...
    let ntnnoErr = "";
    if (!ntnno != "") {
      ntnnoErr = "invalid ntnnoErr";
      console.log("inValidat");
    }

    if (ntnnoErr) {
      setntnnoErr({ ntnnoErr });
      return false;
      console.log("inValid");
    }
    return true;
  ...
  const Upnext = () => {
    ...
    let isvalidfile3 = validfile3();
    let isvalidfile4 = validfile4();
    let isvalidfile5 = validfile5();
    if (
      isvalidfile1 &&
      isvalidfile2 &&
      isvalidfile3 &&
    ...
    if (isvalidfile3) {
      var x = document.getElementById("myDIVid1");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVid1");
      x.style.display = "block";
    ...
    if (isvalidfile4) {
      var x = document.getElementById("myDIVid2");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVid2");
      x.style.display = "block";
    ...
    if (isvalidfile5) {
      var x = document.getElementById("myDIVid3");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVid3");
      x.style.display = "block";
  ...
  const fnnext = () => {
    let isvalidsname = validsname();
    let isvalidlandline = validlandline();
    let isvalidshopno = validshopno();
    let isvaliddeptno = validdeptno();
    let isvalidmarkdeptno = validmarkdeptno();
    let isvalidoffemail = validoffemail();
    let isvalidoffwnumber = validoffwnumber();
    let isvalidshopregaddress = validshopregaddress();
    let isvalidntnno = validntnno();
    if (
      isvalidsname &&
      isvalidlandline &&
      isvalidshopno &&
    ...
    if (isvalidsname) {
      var x = document.getElementById("myDIVfnname");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVfnname");
      x.style.display = "block";
    ...
    if (isvalidlandline) {
      var x = document.getElementById("myDIVllno");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVllno");
      x.style.display = "block";
    ...
    if (isvalidshopno) {
      var x = document.getElementById("myDIVcn");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVcn");
      x.style.display = "block";
    ...
    if (isvaliddeptno) {
      var x = document.getElementById("myDIVsdno");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVsdno");
      x.style.display = "block";
    }
    if (isvalidmarkdeptno) {
      var x = document.getElementById("myDIVmdno");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVmdno");
      x.style.display = "block";
    ...
    if (isvalidoffemail) {
      var x = document.getElementById("myDIVomail");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVomail");
      x.style.display = "block";
    }
    if (isvalidoffwnumber) {
      var x = document.getElementById("myDIVowno");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVowno");
      x.style.display = "block";
    }
    if (isvalidshopregaddress) {
      var x = document.getElementById("myDIVfradd");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVfradd");
      x.style.display = "block";
    ...
    if (isvalidntnno) {
      var x = document.getElementById("myDIVntno");
      x.style.display = "none";
    } else {
      var x = document.getElementById("myDIVntno");
      x.style.display = "block";
  ...
  const getalldata = async () => {
    ...
    if (
      ...
      data.append("shopno", shopno);

      data.append("markdeptno", markdeptno);
      data.append("offemail", offemail);
      data.append("offwnumber", offwnumber);
      data.append("shopregaddress", shopregaddress);
      data.append("ntnno", ntnno);
        ...
        <>
          <div id="navigation-pills">
            <h1 className={classes.textCenter}>
              <small>Franchise Owner Registration</small>
            </h1>
            <br />
            ...
            >
              ...
              >
                <div>
                  <GridContainer className="inputs">
                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      ...
                      <div
                        ...
                        style={{ display: "none", color: "red" }}
                      >
                        Franchise Name missing
                      </div>
                    </GridItem>

                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      <CustomInput
                        labelText="Contact No (Landline)"
                        id="float"
                        formControlProps={{
                          fullWidth: true,
                        }}
                        inputProps={{
                          type: "email",
                          onChange: (e) => setshoplandline(e.target.value),
                        }}
                      />
                      <div
                        id="myDIVllno"
                  ...
                  <GridContainer className="inputs">
                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      <CustomInput
                        labelText="Support Dept Contact No"
                        id="float"
                        formControlProps={{
                          fullWidth: true,
                        }}
                      ...
                      <div
                        ...
                        style={{ display: "none", color: "red" }}
                      >
                        Support Dept Contact No missing
                      </div>
                    </GridItem>

                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      <CustomInput
                        labelText="Marketing Dept Contact No"
                        id="float"
                        formControlProps={{
                          fullWidth: true,
                        }}
                        inputProps={{
                          type: "email",
                          onChange: (e) => setmarkdeptno(e.target.value),
                        }}
                      />
                      <div
                        id="myDIVmdno"
                        style={{ display: "none", color: "red" }}
                      >
                        Marketing Dept Contact No missing
                      </div>
                    </GridItem>
                  </GridContainer>
                  ...
                  <GridContainer className="inputs">
                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      ...
                      <div
                        ...
                        style={{ display: "none", color: "red" }}
                      >
                        Official Email missing @ sign
                      </div>
                    </GridItem>

                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      <CustomInput
                        labelText="Official Whatsapp"
                        id="float"
                        formControlProps={{
                          fullWidth: true,
                        }}
                        inputProps={{
                          type: "email",
                          onChange: (e) => setoffwnumber(e.target.value),
                        }}
                      />
                      <div
                        id="myDIVowno"
                        style={{ display: "none", color: "red" }}
                      >
                        Official Whatsapp missing
                      </div>
                    </GridItem>
                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      <CustomInput
                        labelText="Franchise Registration Address"
                        id="float"
                        formControlProps={{
                          fullWidth: true,
                        }}
                        inputProps={{
                          type: "email",
                          onChange: (e) => setshopregaddress(e.target.value),
                        }}
                      />
                      <div
                        id="myDIVfradd"
                        style={{ display: "none", color: "red" }}
                      >
                        Franchise Registration Address missing
                      </div>
                    </GridItem>
                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      <CustomInput
                        labelText="NTN Registration No"
                        id="float"
                        formControlProps={{
                          fullWidth: true,
                        }}
                  ...
                  <GridContainer className="inputs">
                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      <Button color="default" onClick={fnBack}>
                        Back
                      </Button>
                    </GridItem>
                    ...
                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      <Button color="info" onClick={fnnext}>
                        Next
                      </Button>
                    </GridItem>
                  </GridContainer>
              ...
              <Tab eventKey="bank" title="Bank Info" disabled={tab4}>
                <div>
                  <GridContainer className="inputs">
                    <GridItem xs={12} sm={4} md={4} lg={3}>
                      <CustomInput
